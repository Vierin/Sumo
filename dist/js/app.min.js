...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Animations\": () => (/* binding */ Animations)\n/* harmony export */ });\n/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ \"./node_modules/gsap/index.js\");\n/* harmony import */ var gsap_src_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap/src/ScrollTrigger.js */ \"./node_modules/gsap/src/ScrollTrigger.js\");\n/* harmony import */ var gsap_dist_SplitText_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! gsap/dist/SplitText.min.js */ \"./node_modules/gsap/dist/SplitText.min.js\");\n\r\n\r\n\r\n\r\ngsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_src_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger);\r\ngsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_dist_SplitText_min_js__WEBPACK_IMPORTED_MODULE_2__.SplitText);\r\n\r\ngsap_src_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.defaults({\r\n    start: \"top 90%\"\r\n});\r\n\r\nclass Animations {\r\n\r\n    constructor() {\r\n        this.cache = {};\r\n        this.load();\r\n    }\r\n\r\n    load() {\r\n        this.animations = [];\r\n\r\n        this.saveCache();\r\n        this.setActions();\r\n    }\r\n\r\n    saveCache() {\r\n        this.cache = [...document.querySelectorAll('[data-scroll]')].map((el) => {\r\n\r\n            this.animations.push({\r\n                el,\r\n                done: el.classList.contains('is-animated'),\r\n                type: el.dataset.scroll\r\n            });\r\n        });\r\n\r\n        this.animations.forEach(item => {\r\n            gsap_src_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.create({\r\n                trigger: item.el,\r\n                onEnter: () => {\r\n                    item.el.classList.add('is-animated');\r\n                }\r\n            })\r\n        });\r\n\r\n    }\r\n\r\n    setActions() {\r\n        this.animations.forEach(item => {\r\n\r\n            switch (item.type) {\r\n\r\n                case 'title':\r\n                    const letters = new gsap_dist_SplitText_min_js__WEBPACK_IMPORTED_MODULE_2__.SplitText(item.el, {type: 'words, chars'})\r\n                    const stagger = item.el.dataset.stagger;\r\n                    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(letters.chars, {\r\n                        scrollTrigger: {\r\n                            trigger: item.el,\r\n                        },\r\n                        yPercent: 110,\r\n                        stagger: stagger ? stagger : .04,\r\n                    });\r\n                    break;\r\n\r\n                case 'lines':\r\n                    const lines = new gsap_dist_SplitText_min_js__WEBPACK_IMPORTED_MODULE_2__.SplitText(item.el, {type: 'lines'})\r\n                    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(lines.lines, {\r\n                        scrollTrigger: {\r\n                            trigger: item.el,\r\n                        },\r\n                        yPercent: 110,\r\n                        stagger: .05\r\n                    });\r\n                    break;\r\n\r\n\r\n                case 'line':\r\n                    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(item.el, {\r\n                        scrollTrigger: {\r\n                            trigger: item.el,\r\n                        },\r\n                        scaleX: 0,\r\n                        transformOrigin: \"left\",\r\n                        duration: .7,\r\n                        delay: .4\r\n                    });\r\n                    break;\r\n\r\n                case 'fadeUp':\r\n                    const delay = item.el.dataset.delay;\r\n\r\n                    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({\r\n                        scrollTrigger: {\r\n                            trigger: item.el,\r\n                        }})\r\n                        .fromTo(item.el, { y: 40, opacity: 0 }, { duration: .5, y: 0, opacity: 1, delay: delay ? delay : 0});\r\n                    break;\r\n\r\n                case 'scroll':\r\n                    const line = item.el.querySelector('span');\r\n\r\n                    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(line, {\r\n                        scrollTrigger: {\r\n                            trigger: item.el,\r\n                        },\r\n                        scaleY: 0,\r\n                        duration: .7,\r\n                        transformOrigin: 'top',\r\n                        duration: .3\r\n                    });\r\n                    break;\r\n\r\n                case 'words':\r\n                    const splitText = new gsap_dist_SplitText_min_js__WEBPACK_IMPORTED_MODULE_2__.SplitText(item.el, {type: 'lines, words', linesClass: \"text-line\"})\r\n\r\n                    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(splitText.words, {\r\n                        scrollTrigger: {\r\n                            trigger: item.el,\r\n                        },\r\n                        yPercent: 120,\r\n                        stagger: .04,\r\n                    });\r\n                    break;\r\n\r\n\r\n                default:\r\n                    if (item.type) {\r\n                        console.warn(`There's no \"${item.type}\" scroll animation`);\r\n                    }\r\n                    break;\r\n            }\r\n\r\n        });\r\n    }\r\n\r\n}\r\n\r\n\n\n//# sourceURL=webpack://gulp-2022/./src/js/components/Animations.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Hero\": () => (/* binding */ Hero)\n/* harmony export */ });\n/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ \"./node_modules/gsap/index.js\");\n/* harmony import */ var gsap_src_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap/src/ScrollTrigger.js */ \"./node_modules/gsap/src/ScrollTrigger.js\");\n/* harmony import */ var gsap_src_ScrollToPlugin_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! gsap/src/ScrollToPlugin.js */ \"./node_modules/gsap/src/ScrollToPlugin.js\");\n\r\n\r\n\r\n\r\ngsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_src_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]);\r\ngsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_src_ScrollToPlugin_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\r\n\r\nclass Hero {\r\n    constructor() {\r\n        this.view = document.querySelector('[data-component=\"Hero\"]');\r\n\r\n        if(this.view) {\r\n            this.init();\r\n        }\r\n    }\r\n\r\n\r\n\r\n\r\n    init() {\r\n        this.head = this.view.querySelector('.js-hero-head');\r\n        this.intro = this.view.querySelector('.js-hero-intro');\r\n        const duration = .5;\r\n        const html = document.documentElement;\r\n\r\n        const target = this.view.querySelector('.js-hero-intro').offsetTop;\r\n        ///test\r\n        let panels = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray(\".js-section\"),\r\n            scrollTween;\r\n\r\n        panels.forEach((panel, i) => {\r\n            gsap_src_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].create({\r\n                trigger: panel,\r\n                start: \"top bottom\",\r\n                markers: false,\r\n                end: \"+=200%\",\r\n                onToggle: self => {\r\n                    if(self.isActive && !scrollTween) {\r\n                        if(self.trigger.classList.contains('js-dark')) {\r\n                            document.querySelector('.js-header').classList.add('is-section-dark');\r\n                            this.view.classList.add('is-active');\r\n                        } else {\r\n                            document.querySelector('.js-header').classList.remove('is-section-dark');\r\n                            this.view.classList.remove('is-active');\r\n                        }\r\n\r\n                        scrollTween = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(window, {\r\n                                scrollTo: {y: i * innerHeight, autoKill: false},\r\n                                duration: 1,\r\n                                onComplete: () => scrollTween = null,\r\n                                overwrite: true\r\n                        });\r\n                    }\r\n                }\r\n            });\r\n        });\r\n\r\n        this.moveCircle();\r\n    }\r\n\r\n\r\n    moveCircle() {\r\n        const area = this.view.querySelector('.js-area');\r\n        const circle = this.view.querySelector('.js-circle-area');\r\n\r\n        // console.log(circle);\r\n        const half = circle.clientWidth * .5;\r\n        const startTop = circle.offsetTop;\r\n        const startLeft = circle.offsetLeft;\r\n\r\n    //    console.log(startTop, startLeft);\r\n\r\n        area.addEventListener('mouseout', (e) => {\r\n            gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(circle, {top: startTop + \"px\", left: startLeft + \"px\"})\r\n\r\n        })\r\n\r\n        area.addEventListener('mousemove', (e) => {\r\n            let x = e.clientX - half;\r\n            let y = e.clientY - half;\r\n            gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(circle, {top: y + \"px\", left: x + \"px\"})\r\n        })\r\n    }\r\n\r\n\r\n}\n\n//# sourceURL=webpack://gulp-2022/./src/js/components/Hero.js?");

/***/ }),

/***/ "./src/js/components/SwiperMulti.js":
/*!******************************************!*\
  !*** ./src/js/components/SwiperMulti.js ***!
  \******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
